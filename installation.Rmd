...
```{r installation-common, include = FALSE}
source("_common.R")
```
...
```{r, out.width = "100%", fig.cap = "Terminalの起動", echo = FALSE}
knitr::include_graphics("Figures/Installation/R_Ubuntu1.png")
```
...
```{r, out.width = "100%", fig.cap = "Applicationから起動1", echo = FALSE}
knitr::include_graphics("Figures/Installation/R_Ubuntu2.png")
```

2つ目の方法はApplicationから開く方法です。Ubuntuの左上の「Activities (アクティビティ)」または、左下のボタンをクリックします。

```{r, out.width = "100%", fig.cap = "Applicationから起動2", echo = FALSE}
knitr::include_graphics("Figures/Installation/R_Ubuntu3.png")
```

上段中央の検索で「R」を入力し、検索結果からRを選択します。

```{r linux-r-console, out.width = "100%", fig.cap = "R Console", echo = FALSE}
knitr::include_graphics("Figures/Installation/R_Ubuntu4.png")
```
...
```{r, out.width = "100%", fig.cap = "Rのインストール1 (Windows)", echo = FALSE}
knitr::include_graphics("Figures/Installation/R_Windows1.png")
```

CRAN (https://cran.r-project.org/)にアクセスし、「Download R for Windows」を選択します。

```{r, out.width = "100%", fig.cap = "Rのインストール2 (Windows)", echo = FALSE}
knitr::include_graphics("Figures/Installation/R_Windows2.png")
```

「base」を選択します。

```{r, out.width = "100%", fig.cap = "Rのインストール3 (Windows)", echo = FALSE}
knitr::include_graphics("Figures/Installation/R_Windows3.png")
```
...
```{r, out.width = "50%", fig.cap = "bitの確認 (1)", echo = FALSE}
knitr::include_graphics("Figures/Installation/R_Windows_Pre1.png")
```

1. デスクトップ画面のPCを**右クリック**し、「プロパティ」を選択

```{r, out.width = "100%", fig.cap = "bitの確認 (2)", echo = FALSE}
knitr::include_graphics("Figures/Installation/R_Windows_Pre2.png")
```
...
```{r, out.width = "100%", fig.cap = "RStudioのインストール1", echo = FALSE}
knitr::include_graphics("Figures/Installation/RStudio1.png")
```

まず、RStudioのホームページ (https://rstudio.com)にアクセスし、「Download」をクリックします。

```{r, out.width = "100%", fig.cap = "RStudioのインストール2", echo = FALSE}
knitr::include_graphics("Figures/Installation/RStudio2.png")
```

RStudio Desktopの「Download」を選択します。

```{r, out.width = "100%", fig.cap = "RStudioのインストール3", echo = FALSE}
knitr::include_graphics("Figures/Installation/RStudio3.png")
```
...
```{r RStudio1, out.width = "100%", fig.cap = "RStudioの初期画面", echo = FALSE}
knitr::include_graphics("Figures/Installation/RStudio_Setting1.png")
```
...
```{r PaneExample, out.width = "100%", fig.cap = "Pane設定後", echo = FALSE}
knitr::include_graphics("Figures/Installation/RStudio_Setting4.png")
```
