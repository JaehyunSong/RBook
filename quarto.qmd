...
　また、この機能はチャンクで生成された図についても使用かのうだ。チャンクオプションに`#| layout-ncol: 2`を追加すると、2つの図が横に並ぶことになる。詳しくは[Quarto公式レファレンス](https://quarto.org/docs/authoring/figures.html#computations)を参照すること。
