...
![RStudio](https://quarto.org/docs/get-started/hello/images/rstudio-hello.png){height=200px}

![VS Code](https://quarto.org/docs/tools/images/vscode-render.png){height=200px}

![Jupyter](https://quarto.org/docs/get-started/hello/images/jupyter-quarto-preview.png){height=200px}

![NeoVim](https://quarto.org/docs/get-started/hello/images/neovim-overview.png){height=200px}
...
　1つ目はQuarto CLIのインストールだ。Quarto CLIは[公式ホームページ](https://quarto.org/docs/get-started/)からダウンロードできる（<https://quarto.org/docs/get-started/>）。macOS、Linux、Windows版が提供されているため、自分のOSに合わせてダウンロードし、インストールしておこう。最新のRStudioにはQuartoが内蔵されているが、最新のQuarto CLIが内蔵されているわけではない。むろん、新機能にこだわりがないのであれば、最新のRStudioをインストールするだけでも十分だ。
