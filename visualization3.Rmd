...
```{r visual3-common, include = FALSE}
source("_common.R")
```
...
```{r visual3-labs-1, fig.width = 4, fig.height = 4, cache = TRUE}
Country_df %>%
    ggplot() +
...
```{r visual3-labs-2, fig.width = 5, fig.height = 4, cache = TRUE}
Country_df %>%
    ggplot() +
...
```{r visual3-labs-3, fig.width = 5, fig.height = 4, cache = TRUE}
Country_df %>%
    ggplot() +
    geom_point(aes(x = FH_Total, y = GDP_per_capita, color = Continent)) +
...
```{r visual3-labs-4, fig.width = 5, fig.height = 4, cache = TRUE}
Country_df %>%
    ggplot() +
    geom_point(aes(x = FH_Total, y = GDP_per_capita, color = Continent)) +
    labs(x = "フリーダムハウススコア",y = "一人あたりGDP (USD)", color = "大陸",
...
```{r visual3-coord-1, fig.width = 8, fig.height = 4, cache = TRUE}
Fig1 <- COVID19_df %>%
...
```{r visual3-coord-2, fig.width = 8, fig.height = 4, cache = TRUE}
Fig1 +
...
```{r visual3-coord-3, fig.width = 4, fig.height = 4, cache = TRUE}
...
```{r visual3-coord-4, fig.width = 4, fig.height = 4, cache = TRUE}
Fig2 +
...
```{r visual3-coord-7, fig.width = 5, fig.height = 4, cache = TRUE}
Flip_Fig <- Country_df %>%
  group_by(Continent) %>%
...
```{r visual3-coord-8, fig.width = 5, fig.height = 4, cache = TRUE}
Flip_Fig +
  coord_flip() # 座標系の回転
```
...
```{r visual3-coord-9, fig.width = 5, fig.height = 2.5, cache = TRUE}
ggplot() +
...
```{r visual3-coord-10, fig.width = 2.5, fig.height = 5, cache = TRUE}
ggplot() +
  geom_point(aes(x = 1:10, y = 1:10))
```
...
```{r visual3-coord-11, fig.width = 4, fig.height = 4}
ggplot() +
  geom_point(aes(x = 1:10, y = 1:10)) +
  coord_fixed(ratio = 1)
```
...
```{r visual3-scale-continuous-1, fig.width = 5, fig.height = 4, cache = TRUE}
...
```{r visual3-scale-continuous-2, eval = FALSE}
Scale_Fig1 +
...
```{r visual3-scale-continuous-3, fig.width = 5, fig.height = 4, cache = TRUE}
Scale_Fig1 +
...
```{r visual3-scale-continuous-4, fig.width = 5, fig.height = 4, cache = TRUE}
Scale_Fig1 +
...
```{r visual3-scale-continuous-5, fig.width = 5, fig.height = 4, cache = TRUE}
Scale_Fig1 +
  scale_x_continuous(breaks = seq(0, 100, by = 10),
                     labels = seq(0, 100, by = 10)) +
...
```{r visual3-scale-continuous-6, fig.width = 5, fig.height = 4, cache = TRUE}
Scale_Fig1 +
...
```{r visual3-scale-discrete-1, fig.width = 5, fig.height = 4, cache = TRUE}
Flip_Fig +
...
```{r visual3-scale-discrete-2, fig.width = 5, fig.height = 4, cache = TRUE}
...
```{r visual3-scale-discrete-4, fig.width = 5, fig.height = 4, cache = TRUE}
Scale_df1 %>% 
  ggplot() +
...
```{r visual3-scale-discrete-5, fig.width = 5, fig.height = 4, cache = TRUE}
Scale_df1 %>% 
  ggplot() +
  geom_bar(aes(x = Polity_Type, y = N), stat = "identity") +
...
```{r visual3-scale-color-1, fig.width = 6, fig.height = 4, cache = TRUE}
...
```{r visual3-scale-color-2, fig.width = 6, fig.height = 4, cache = TRUE}
Scale_Fig2 +
...
```{r visual3-scale-color-4, fig.width = 6, fig.height = 4, cache = TRUE}
Scale_Fig2 +
...
```{r visual3-scale-color-5, fig.width = 6, fig.height = 4, cache = TRUE}
...
```{r visual3-scale-color-6, fig.width = 6, fig.height = 4, cache = TRUE}
...
```{r visual3-scale-color-7, echo = FALSE}
pacman::p_load(scales)
# Hueは0から360まで、彩度は100、明るさ65、範囲内の36色を出力
# タイルは6列、ラベルなし、ボーダーの太さは１
hue_pal(h = c(0, 360), c = 100, l = 65)(36) %>%
  show_col(ncol = 6, label = FALSE, borders = 1)
```
...
```{r visual3-scale-color-8, fig.width = 6, fig.height = 4, cache = TRUE}
Scale_Fig3 +
...
```{r visual3-scale-color-9, fig.width = 6, fig.height = 4, cache = TRUE}
Scale_Fig3 +
...
```{r visual3-scale-color-10, fig.width = 6, fig.height = 4, cache = TRUE}
Scale_Fig3 +
...
```{r visual3-scale-color-11, fig.width = 6, fig.height = 4, cache = TRUE, eval = FALSE}
ggplot2オブジェクト +
...
```{r visual3-scale-color-12, fig.width = 6, fig.height = 4, cache = TRUE}
Scale_Fig3 +
...
```{r visual3-scale-size-1, fig.width = 6, fig.height = 4, cache = TRUE}
Country_df %>%
    ggplot() +
...
```{r visual3-scale-size-2, fig.width = 6, fig.height = 4, cache = TRUE}
Country_df %>%
    ggplot() +
    geom_point(aes(x = FH_Total, y = HDI_2018, size = PPP_per_capita),
               alpha = 0.5) + # 透明度の指定
...
```{r visual3-scale-size-3, fig.width = 6, fig.height = 4, cache = TRUE}
Country_df %>%
    ggplot() +
    geom_point(aes(x = FH_Total, y = HDI_2018, size = PPP_per_capita),
               alpha = 0.5) +
...
```{r visual3-scale-size-4, fig.width = 6, fig.height = 4, cache = TRUE}
Country_df %>%
    ggplot() +
    geom_point(aes(x = FH_Total, y = HDI_2018, size = PPP_per_capita),
               alpha = 0.5) +
...
```{r visual3-scale-shape-1, fig.width = 6, fig.height = 4, cache = TRUE}
Country_df %>%
...
```{r visual3-scale-shape-2, fig.width = 6, fig.height = 4, cache = TRUE}
Country_df %>%
    mutate(G20 = if_else(G20 == 1, "加盟国", "非加盟国")) %>%
    ggplot() +
    geom_point(aes(x = FH_Total, y = HDI_2018, shape = G20),
...
```{r visual3-scale-shape-3, echo = FALSE, fig.width = 7, fig.height = 1.5, cache = TRUE}
data.frame(p = c(0:25)) %>%
  ggplot() +
  geom_point(aes(x = p %% 16, y = p %/% 16, shape = p), 
             size = 5, fill = "red") +
  geom_text(aes(x = p %% 16, y = p %/% 16 + 0.25, label = p), 
            size = 3) +
...
```{r visual3-scale-shape-4, echo = FALSE, fig.width = 8, fig.height = 4, cache = TRUE}
set.seed(1986)
shape.df <- tibble(
  x = rnorm(100, 0, 2),
  y = 1 + if_else(x >= 0, 0.3, 2) * x + rnorm(100, 0, 1))

Shape.Fig1 <- shape.df %>%
  mutate(type = if_else(x >= 1, "A", "B")) %>%
  ggplot() +
  geom_point(aes(x = x, y = y, shape = type), size = 2) +
  guides(shape = "none") +
  labs(x = "", y = "") +
  theme_minimal() +
...
Shape.Fig2 <- shape.df %>%
  mutate(type = sample(c("A", "B"), 100, replace = TRUE)) %>%
  ggplot() +
  geom_point(aes(x = x, y = y, shape = type), size = 2) +
  guides(shape = "none") +
  labs(x = "", y = "") +
...
ggpubr::ggarrange(Shape.Fig1, Shape.Fig2,labels = c("(A)", "(B)"))
```

　白黒のグラフの場合、色分けが出来ないため、次元拡張には点の形を変えることになります。しかし、色に来れば形は読み手にとって認知の負荷がかかりやすいです。下の図を見てください。100個の点がありますが、三角の点はいくつでしょうか。

```{r visual3-scale-shape-5, echo = FALSE, fig.width = 3, fig.height = 3, cache = TRUE}
expand.grid(x = 1:10, y = 1:10) %>%
  mutate(z = sample(c(rep("R", 5), rep("B", 95)))) %>%
  ggplot() +
  geom_point(aes(x = x, y = y, shape = z), size = 3) +
  labs(x = "", y = "") +
  guides(shape = "none") +
  theme_minimal() +
  theme(axis.text = element_blank(),
...
```{r visual3-scale-shape-6, echo = FALSE, fig.width = 3, fig.height = 3, cache = TRUE}
expand.grid(x = 1:10, y = 1:10) %>%
  mutate(z = sample(c(rep("R", 5), rep("B", 95)))) %>%
  ggplot() +
  geom_point(aes(x = x, y = y, color = z), size = 3) +
  scale_color_manual(values = c("R" = "red", "B" = "black")) +
  labs(x = "", y = "") +
  guides(color = "none") +
  theme_minimal() +
  theme(axis.text = element_blank(),
...
```{r visual3-scale-shape-7, fig.width = 8, fig.height = 5, cache = TRUE}
...
```{r visual3-scale-shape-8, fig.width = 8, fig.height = 5, cache = TRUE}
left_join(COVID19_df, Country_df, by = "Country") %>% 
  mutate(Date                 = as.Date(Date),
         Confirmed_per_capita = Confirmed_Day / Population * 10000,
...
```{r visual3-scale-shape-9, fig.width = 8, fig.height = 5, cache = TRUE}
left_join(COVID19_df, Country_df, by = "Country") %>% 
  mutate(Date                 = as.Date(Date),
         Confirmed_per_capita = Confirmed_Day / Population * 10000,
         Japan                = if_else(Country == "Japan", "日本", "その他")) %>%
...
```{r visual3-scale-shape-10, fig.width = 8, fig.height = 5, cache = TRUE}
left_join(COVID19_df, Country_df, by = "Country") %>% 
  mutate(Date                 = as.Date(Date),
         Confirmed_per_capita = Confirmed_Day / Population * 10000,
         Japan                = if_else(Country == "Japan", "日本", "その他"),
...
```{r visual3-theme-1, echo = FALSE, fig.width = 8, fig.height = 8, cache = TRUE, warning = FALSE}
Theme_Fig <- Country_df %>%
  ggplot() +
  geom_point(aes(x = Polity_Score, y = PPP_per_capita)) +
  labs(x = "Polity IV Score", y = "PPP per capita (USD)")

ggpubr::ggarrange(Theme_Fig + theme_gray() + facet_wrap(~ "theme_gray()"),
                  Theme_Fig + theme_bw() + facet_wrap(~ "theme_bw()"),
                  Theme_Fig + theme_light() + facet_wrap(~ "theme_light()"),
                  Theme_Fig + theme_dark() + facet_wrap(~ "theme_dark()"),
                  Theme_Fig + theme_linedraw() + facet_wrap(~ "theme_linedraw()"),
                  Theme_Fig + theme_minimal() + facet_wrap(~ "theme_minimal()"),
                  Theme_Fig + theme_void() + facet_wrap(~ "theme_void()"),
                  Theme_Fig + theme_test() + facet_wrap(~ "theme_test()"),
...
```{r visual3-theme-2, cache = TRUE, fig.width = 5, fig.height = 5}
Theme_Fig <- Country_df %>%
...
```{r visual3-theme-3, cache = TRUE, fig.width = 5, fig.height = 5}
Theme_Fig +
...
```{r visual3-theme-4, cache = TRUE, fig.width = 5, fig.height = 5}
# すべてのグリッドを除去
Theme_Fig +
  theme(panel.grid = element_blank())
...
```{r visual3-theme-5, cache = TRUE, fig.width = 5, fig.height = 5}
Theme_Fig +
  theme(text = element_text(size = 16),
...
```{r visual3-theme-6, cache = TRUE, fig.width = 5, fig.height = 5}
Theme_Fig +
  theme(text = element_text(size = 16),
...
```{r visual3-theme-8, cache = TRUE, fig.width = 5, fig.height = 5}
Theme_Fig +
  scale_x_discrete(guide = guide_axis(n.dodge = 2)) +
  theme(text = element_text(size = 16))
```
...
```{r visual3-theme-9, cache = TRUE, fig.width = 5, fig.height = 5}
Theme_Fig +
...
```{r visual3-legend-1, cache = TRUE, fig.width = 5, fig.height = 5}
# 凡例を非表示にする
Theme_Fig +
...
```{r visual3-legend-2, cache = TRUE, fig.width = 5, fig.height = 5}
...
```{r visual3-legend-3, cache = TRUE, fig.width = 5, fig.height = 5}
Theme_Fig2 +
...
```{r visual3-legend-4, cache = TRUE, fig.width = 5, fig.height = 5}
Theme_Fig2 +
  guides(fill = "none")
```
...
```{r visual3-legend-5, cache = TRUE, fig.width = 5, fig.height = 5}
# 凡例を図の下段へ移動
Theme_Fig +
  theme(legend.position = "bottom")
```
...
```{r visual3-legend-6, cache = TRUE, fig.width = 5, fig.height = 5}
# 凡例をプロットの右上へ
Theme_Fig +
...
```{r visual3-legend-7, cache = TRUE, fig.width = 5, fig.height = 5}
# 凡例の中心を凡例の右上と指定
Theme_Fig +
  theme(legend.position = c(1, 1),
...
```{r visual3-legend-8, cache = TRUE, fig.width = 5, fig.height = 5}
# 凡例を背景を透明に
Theme_Fig +
  theme(legend.position = c(1, 1),
        legend.justification = c(1, 1),
...
```{r visual3-merge-1, warning = FALSE, cache = TRUE}
# Grid_Fig1: 散布図
...
```{r visual3-merge-2, echo = FALSE, fig.width = 8, fig.height = 8, cache = TRUE, warning = FALSE}
ggpubr::ggarrange(Grid_Fig1 + facet_wrap(~ "Grid_Fig1"), 
                  Grid_Fig2 + facet_wrap(~ "Grid_Fig2"),
                  Grid_Fig3 + facet_wrap(~ "Grid_Fig3"), 
                  Grid_Fig4 + facet_wrap(~ "Grid_Fig4"),
                  align = "hv")
```
...
```{r visual3-merge-7, echo = FALSE}
tibble(X1 = c("`Grid_Fig3`", "`Grid_Fig4`"), 
       X2 = c("`Grid_Fig1`", "")) %>%
  kableExtra::kbl(col.names = NULL) %>%
  kableExtra::kable_classic(full_width = FALSE) %>%
  kableExtra::kable_styling(bootstrap_options = "bordered") %>%
...
```{r visual3-merge-8, warning = FALSE, cache = TRUE}
...
```{r visual3-merge-9, warning = FALSE}
ggarrange(Grid_Fig3, 
          NULL, 
          Grid_Fig1, 
          Grid_Fig4,
...
```{r visual3-merge-10, warning = FALSE}
