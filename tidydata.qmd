...
たとえば、 @tbl-tidydata_tidydata の場合、各列は以下のような3つの情報があります。
...
![1つの列は、1つの変数を表す](Figs/Tidydata/TidyData1.png){#fig-tidydata_example1 width="50%" fig-align="center"}
...
![1つの行は、1つの観測を表す](Figs/Tidydata/TidyData2.png){#fig-tidydata_example2 width="50%" fig-align="center"}
