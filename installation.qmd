...
#### Step 1: Command Line Toolsのインストール
...
#### Step 2: Fortranコンパイラーのインストール

　まず、以下のページへアクセスする。

- <https://mac.r-project.org/tools/>

　続いて、画面から`gfortran-数字-universal.pkg`のリンクをクリックする。数字の箇所は2026年2月現在、14.2だが、今後より大きくなる可能性がある。ファイルだダウンロードされたら、ダウンロードしたファイルを実行し、支持に従ってインストールする。

![](Figs/Install/gfortran.png){fig-align="center" width="500px"}
