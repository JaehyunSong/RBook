...
![RStudio](Figs/IDE/RStudio.png){.lightbox group="ide"}

![R Tools for Visual Studio](Figs/IDE/RTVS.png){.lightbox group="ide"}

![Visual Studio Code](Figs/IDE/vscode.png){.lightbox group="ide"}
