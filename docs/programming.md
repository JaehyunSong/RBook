...
　たとえば、Rコンソール上で`?mean`を入力して実行すると、図\@ref(fig:programming-intro-4)のような `mean()` 関数のヘルプが表示される。ヘルプに示されているとおり、`mean()`関数に必要な引数は `x`、`trim`、`na.rm`である。仮引数`x`の説明を読むと、`x` の実引数にはnumeric または logical  のベクトルクラスが使えることが分かる。さらに、date、date-time、time interval が使えることも教えてくれる。


<div class="figure" style="text-align: center">
<img src="Figures/Programming/help.png" alt="`mean()`関数のヘルプ画面" width="70%" />
<p class="caption">(\#fig:programming-intro-4)`mean()`関数のヘルプ画面</p>
</div>
...
<p class="caption">(\#fig:programming-style-26)パンチカードの例</p>
</div>
...
## [1] "2回目のサイコロ投げの結果: 3（これまでの総和: 8）"
## [1] "3回目のサイコロ投げの結果: 5（これまでの総和: 13）"
## [1] "4回目のサイコロ投げの結果: 6（これまでの総和: 19）"
## [1] "5回目のサイコロ投げの結果: 2（これまでの総和: 21）"
## [1] "6回目のサイコロ投げの結果: 3（これまでの総和: 24）"
## [1] "7回目のサイコロ投げの結果: 1（これまでの総和: 25）"
## [1] "8回目のサイコロ投げの結果: 1（これまでの総和: 26）"
## [1] "9回目のサイコロ投げの結果: 5（これまでの総和: 31）"
```
...
## [1] "2回目のサイコロ投げの結果: 1 （これまでの総和: 2）"
## [1] "3回目のサイコロ投げの結果: 6 （これまでの総和: 8）"
## [1] "4回目のサイコロ投げの結果: 3 （これまでの総和: 11）"
## [1] "5回目のサイコロ投げの結果: 2 （これまでの総和: 13）"
## [1] "6回目のサイコロ投げの結果: 3 （これまでの総和: 16）"
## [1] "7回目のサイコロ投げの結果: 4 （これまでの総和: 20）"
## [1] "8回目のサイコロ投げの結果: 1 （これまでの総和: 21）"
## [1] "9回目のサイコロ投げの結果: 5 （これまでの総和: 26）"
## [1] "10回目のサイコロ投げの結果: 1 （これまでの総和: 27）"
## [1] "11回目のサイコロ投げの結果: 6 （これまでの総和: 33）"
```
...
## 練習問題 {#programming-exercise .unnumbered}
