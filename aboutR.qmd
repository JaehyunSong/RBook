...
#| out-width: "150px"
#| fig-cap: "R Logo"
knitr::include_graphics("Figs/AboutR/Rlogo.png")
```
...
```{r fig-aboutr-gui-cui-compare}
#| out-width: "500px"
#| fig-cap: "CUIとGUIの比較"
knitr::include_graphics("Figs/AboutR/CUI_GUI.png")
```
...
```{r fig-aboutr-gui-rcmdr}
#| out-width: "800px"
#| fig-cap: "R Commander"
knitr::include_graphics("Figs/AboutR/GUI_Rcmdr.png")
```

* [RKWard](https://rkward.kde.org)

```{r fig-aboutr-gui-rkward}
#| out-width: "800px"
#| fig-cap: "RKWard"
knitr::include_graphics("Figs/AboutR/GUI_RKWard.png")
```

* [JASP](https://jasp-stats.org)

```{r fig-aboutr-gui-jasp}
#| out-width: "800px"
#| fig-cap: "JASP"
knitr::include_graphics("Figs/AboutR/GUI_JASP.png")
```

* [jamovi](https://www.jamovi.org)

```{r fig-aboutr-gui-jamovi}
#| out-width: "800px"
#| fig-cap: "jamovi"
knitr::include_graphics("Figs/AboutR/GUI_jamovi.png")
```

* [R AnalyticFlow](https://r.analyticflow.com)

```{r fig-aboutr-gui-ranalyticflow}
#| out-width: "800px"
#| fig-cap: "RAnalyticFlow (画像は公式ホームページから)"
knitr::include_graphics("Figs/AboutR/GUI_RAnalyticFlow.png")
```
