...
:::{#fig-guis layout="[[32,-2,32,-2,32],[-12,32,-12,32,-12]]"}
![[R Commander](https://socialsciences.mcmaster.ca/jfox/Misc/Rcmdr/)](Figs/AboutR/GUI_Rcmdr.png){.lightbox group="gui"}

![[RKWard](https://rkward.kde.org)](Figs/AboutR/GUI_RKWard.png){.lightbox group="gui"}

![[JASP](https://jasp-stats.org)](Figs/AboutR/GUI_JASP.png){.lightbox group="gui"}

![[jamovi](https://www.jamovi.org)](Figs/AboutR/GUI_jamovi.png){.lightbox group="gui"}

![[R AnalyticFlow](https://r.analyticflow.com)](Figs/AboutR/GUI_RAnalyticFlow.png){.lightbox group="gui"}
