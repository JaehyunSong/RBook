...
```{r RStudioCloud, out.width = "100%", fig.cap = "RStudio Cloudの起動画面 (Operaの場合)", echo = FALSE}
knitr::include_graphics("Figures/Installation/RStudioCloud.png")
```
