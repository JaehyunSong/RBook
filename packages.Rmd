...
#| out.width: "75%"
#| fig.cap: "Rパッケージと作業環境"
knitr::include_graphics("Figures/Installation/Package_Workbench.jpg")
```
...
```{r, out.width = "75%", fig.cap = "必要なライブラリがない場合", echo = FALSE}
knitr::include_graphics("Figures/Installation/Package_Ubuntu1.png")
```
