...
#| out.width: "25%"
#| fig.cap: "R Logo"
knitr::include_graphics("figures/AboutR/Rlogo.png")
```
...
#| out.width: "75%"
#| fig.cap: "CUIとGUIの比較"
knitr::include_graphics("figures/AboutR/CUI_GUI.png")
```
...
#| out.width: "75%"
#| fig.cap: "R Commander"
knitr::include_graphics("figures/AboutR/GUI_Rcmdr.png")
```
...
#| out.width: "75%"
#| fig.cap: "RKWard"
knitr::include_graphics("figures/AboutR/GUI_RKWard.png")
```
...
#| out.width: "75%"
#| fig.cap: "JASP"
knitr::include_graphics("figures/AboutR/GUI_JASP.png")
```
...
#| out.width: "75%"
#| fig.cap: "jamovi"
knitr::include_graphics("figures/AboutR/GUI_jamovi.png")
```

* [R AnalyticFlow](https://r.analyticflow.com)

```{r aboutr-ranalyticflow}
#| echo: FALSE
#| out.width: "75%"
#| fig.cap: "RAnalyticFlow (画像は公式ホームページから)"
knitr::include_graphics("figures/AboutR/GUI_RAnalyticFlow.png")
```
...
#| out.width: "75%"
#| fig.cap: "RStudio"
knitr::include_graphics("figures/AboutR/IDE_RStudio.png")
```
...
knitr::include_graphics("figures/AboutR/IDE_RTVS.png")
```
