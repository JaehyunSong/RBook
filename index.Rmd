...
date: '改訂: `r format(Sys.Date(), "%Y年%m月%d日")`'
...
if (knitr::is_latex_output()) {
    ...
    pacman::p_load(metathis)
    meta() %>%
        meta_social(
            title = "R Not for Everyone",
            description = "An Esoteric Guide",
            url = "https://www.jaysong.net/RBook",
            image = "https://www.jaysong.net/RBook/figures/Cover.png",
            og_type = "book",
            og_author = c("Jaehyun Song", "Yuki Yanai"),
            twitter_card_type = "summary",
            twitter_creator = "@Tintstyle"
        )
}
```
...
knitr::include_graphics("figures/Authors/SongYanai.jpg")
```
