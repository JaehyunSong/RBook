...
<p class="caption">(\#fig:unnamed-chunk-2)R Logo</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-3)CUIとGUIの比較</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-4)R Commander</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-5)RKWard</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-6)JASP</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-7)jamovi</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-8)RAnalyticFlow (画像は公式ホームページから)</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-9)RStudio</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-10)R Tools for Visual Studio</p>
</div>
