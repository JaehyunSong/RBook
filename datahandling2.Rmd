...
```{r handling2-common, include = FALSE}
source("_common.R")
```
...
```{r handling2-setup, message = FALSE}
...
```{r handling2-summarise-1, eval = FALSE}
# summarise()関数の使い方
データフレーム名 %>%
...
```{r handling2-summarise-6, eval = FALSE}
# across()の使い方
データフレーム名 %>%
...
```{r handling2-summarise-9, eval = FALSE}
# ラムダ式を用いたacross()の使い方
データフレーム名 %>%
...
```{r handling2-summarise-11, eval = FALSE}
# 以下の3つは同じ機能をする関数である
...
```{r handling2-mutate-1, eval = FALSE}
# mutate()関数の使い方
データフレーム名 %>%
  mutate(新しい変数名 = 処理内容)
```
...
```{r handling2-mutate-3, eval = FALSE}
# コードの3行名を修正 (.before使用)
mutate(Walk_Hour = Walk / 60,
       .before   = Name)
...
```{r handling2-mutate-6, eval = FALSE}
...
```{r handling2-mutate-8, eval = FALSE}
# ifelse()を使う場合
df %>% 
...
```{r handling2-mutate-9, eval = FALSE}
# case_when()を使う場合
df %>% 
...
```{r handling2-mutate-10, eval = FALSE}
# case_when()の使い方
データフレーム名 %>%
...
```{r handling2-mutate-12, eval = FALSE}
# recode()の使い方
データフレーム名 %>%
...
```{r handling2-merge-row-6, error = TRUE}
# rbind()を使う場合
...
```{r handling2-merge-col-1, out.width = "80%", fig.cap = "列の結合", echo = FALSE}
...
```{r handling2-merge-col-3, message = FALSE}
...
```{r handling2-merge-col-6, eval = FALSE}
...
```{r handling2-merge-col-8, out.width = "80%", fig.cap = "(ref:inner-join)", echo = FALSE}
...
```{r handling2-merge-col-10, out.width = "80%", fig.cap = "(ref:full-join)", echo = FALSE}
...
```{r handling2-merge-col-12, out.width = "80%", fig.cap = "(ref:left-join)", echo = FALSE}
...
```{r handling2-merge-col-13, out.width = "80%", fig.cap = "(ref:right-join)", echo = FALSE}
