...
* 第1部: Rの導入
   * 第[-@sec-aboutr]章: R?
   * 第[-@sec-installation]章: Rのインストール
   * 第[-@sec-ide]章: IDEの導入
   * 第[-@sec-customize]章: 分析環境のカスタマイズ
   * 第[-@sec-packages]章: Rパッケージ
* 第2部: Rの基礎
   * 第[-@sec-project]章: プロジェクト管理
   * 第[-@sec-rbasic]章: 基本的な操作
   * 第[-@sec-io]章: データの入出力
   * 第[-@sec-datatype]章: データ型
   * 第[-@sec-datastructure]章: データ構造
   * 第[-@sec-programming]章: Rプログラミングの基礎
   * 第[-@sec-functions]章: 関数の自作
* 第3部: データハンドリング
   * 第[-@sec-datahandling1]章: データハンドリング [抽出]
   * 第[-@sec-datahandling2]章: データハンドリング [拡張]
   * 第[-@sec-factor]章: データハンドリング [factor型]
   * 第[-@sec-tidydata]章: 整然データ構造
   * 第[-@sec-string]章: 文字列の処理
* 第4部: 可視化
   * 第[-@sec-visualization1]章: 可視化[理論]
   * 第[-@sec-visualization2]章: 可視化[基礎]
   * 第[-@sec-visualization3]章: 可視化[応用]
   * 第[-@sec-visualization4]章: 可視化[発展]
   * 第[-@sec-table]章: 表の作成 (70%)
* 第5部: 再現可能な研究
   * 第[-@sec-rmarkdown]章: R Markdown [基礎]
   * 第[-@sec-rmarkdown2]章: R Markdown [応用]
   * 第[-@sec-quarto]章: Quarto入門
   * 第[-@sec-renv]章: 分析環境の管理
* 第6部: 中級者向け
   * 第[-@sec-iteration]章: 反復処理
   * 第[-@sec-oop]章: オブジェクト指向プログラミング
   * 第[-@sec-monte]章: モンテカルロ・シミュレーション
   * 第[-@sec-scraping]章: スクレイピング
* 付録
   * [データセット](dataset.qmd)
