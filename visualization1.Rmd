...
```{r visual1-ggplot-image-3}
#| echo: FALSE
#| message: FALSE
#| fig.width: 8
#| fig.height: 4
#| fig.cap: "第1層: データとキャンバスの用意"
#| cache: TRUE
...
```{r visual1-ggplot-image-4}
#| echo: FALSE
#| message: FALSE
#| fig.width: 8
#| fig.height: 4
#| fig.cap: "第2層: 幾何オブジェクト (折れ線グラフ) の指定とマッピング"
#| cache: TRUE
...
```{r visual1-ggplot-image-5}
#| echo: FALSE
#| message: FALSE
#| fig.width: 8
#| fig.height: 4
#| fig.cap: "第3層: 幾何オブジェクト (散布図) の指定とマッピング"
#| cache: TRUE
...
```{r visual1-ggplot-layer}
#| echo: FALSE
#| out.width: "85%"
#| fig.cap: "{ggplot2}の図が出来上がるまで (全体像)"
#| cache: TRUE
...
```{r visual1-ggplot-structure-1}
#| echo: FALSE
#| out.width: "100%"
#| fig.cap: "{ggplot2}の構造の例"
#| cache: TRUE
...
#| echo: FALSE
Coord_Fig2 <- tibble(x = 1:10, y = 1:10) %>%
  mutate(z = factor(1:10)) %>%
  ggplot() +
...
Coord_Fig2_1 <- Coord_Fig2 +
  ggtitle("直交座標系 (デカルト座標系)") +
  coord_fixed(ratio = 1)

Coord_Fig2_2 <- Coord_Fig2 +
  ggtitle("極座標系") +
  coord_polar()
```
...
ggarrange(Coord_Fig2_1, Coord_Fig2_2)
```
...
```{r visual1-coord-5}
#| echo: FALSE
Coord_Fig3 <- data.frame(x = c(rep("男性", 4), 
                               rep("女性", 5), 
                               rep("ニュータイプ", 1))) %>%
    ggplot() +
...
Coord_Fig3_1 <- Coord_Fig3 + 
  ggtitle("直交座標系 (デカルト座標系)")

Coord_Fig3_2 <- Coord_Fig3 +
    ggtitle("極座標系") +
    coord_polar(theta = "y")
```
...
ggarrange(Coord_Fig3_1, Coord_Fig3_2)
```
...
```{r visual1-3dplot-3}
#| echo: FALSE
#| fig.cap: "図\\@ref(fig:visual1-3dplot-1)を2次元プロットに再構成した例 (棒グラフ)"
#| cache: TRUE
...
```{r visual1-3dplot-4}
#| echo: FALSE
#| fig.cap: "図\\@ref(fig:visual1-3dplot-1)を2次元プロットに再構成した例 (折れ線グラフ)"
#| cache: TRUE
...
temp %>%
  ...
  geom_line(size = 1) +
  geom_point(color = "white", fill = "black", shape = 21, size = 4) +
  scale_x_date(date_labels = "%b/%d", breaks = as.Date(temp$Date)) +
  labs(x = "日付", y = "給付済み金額 (兆円)") +
  theme_bw() +
...
```{r visual1-3dplot-6}
#| echo: FALSE
#| fig.cap: "図\\@ref(fig:visual1-3dplot-5)を2次元プロットに再構成した例"
#| cache: TRUE
