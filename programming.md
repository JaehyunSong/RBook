...
## [1] "3回目のサイコロ投げの結果: 3（これまでの総和: 13）"
## [1] "4回目のサイコロ投げの結果: 4（これまでの総和: 17）"
## [1] "5回目のサイコロ投げの結果: 6（これまでの総和: 23）"
## [1] "6回目のサイコロ投げの結果: 5（これまでの総和: 28）"
## [1] "7回目のサイコロ投げの結果: 2（これまでの総和: 30）"
```
...
## [1] "4回目のサイコロ投げの結果: 4 （これまでの総和: 19）"
## [1] "5回目のサイコロ投げの結果: 3 （これまでの総和: 22）"
## [1] "6回目のサイコロ投げの結果: 6 （これまでの総和: 28）"
## [1] "7回目のサイコロ投げの結果: 4 （これまでの総和: 32）"
```
