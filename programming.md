...
## [1] "2回目のサイコロ投げの結果: 5（これまでの総和: 11）"
## [1] "3回目のサイコロ投げの結果: 6（これまでの総和: 17）"
## [1] "4回目のサイコロ投げの結果: 4（これまでの総和: 21）"
## [1] "5回目のサイコロ投げの結果: 4（これまでの総和: 25）"
## [1] "6回目のサイコロ投げの結果: 2（これまでの総和: 27）"
## [1] "7回目のサイコロ投げの結果: 2（これまでの総和: 29）"
## [1] "8回目のサイコロ投げの結果: 4（これまでの総和: 33）"
```
...
## [1] "3回目のサイコロ投げの結果: 3 （これまでの総和: 11）"
## [1] "4回目のサイコロ投げの結果: 6 （これまでの総和: 17）"
## [1] "5回目のサイコロ投げの結果: 5 （これまでの総和: 22）"
## [1] "6回目のサイコロ投げの結果: 5 （これまでの総和: 27）"
## [1] "7回目のサイコロ投げの結果: 2 （これまでの総和: 29）"
## [1] "8回目のサイコロ投げの結果: 5 （これまでの総和: 34）"
```
