...
## [1] "4回目のサイコロ投げの結果: 5（これまでの総和: 21）"
## [1] "5回目のサイコロ投げの結果: 2（これまでの総和: 23）"
## [1] "6回目のサイコロ投げの結果: 6（これまでの総和: 29）"
## [1] "7回目のサイコロ投げの結果: 5（これまでの総和: 34）"
```
...
## [1] "3回目のサイコロ投げの結果: 1 （これまでの総和: 8）"
## [1] "4回目のサイコロ投げの結果: 5 （これまでの総和: 13）"
## [1] "5回目のサイコロ投げの結果: 3 （これまでの総和: 16）"
## [1] "6回目のサイコロ投げの結果: 4 （これまでの総和: 20）"
## [1] "7回目のサイコロ投げの結果: 1 （これまでの総和: 21）"
## [1] "8回目のサイコロ投げの結果: 1 （これまでの総和: 22）"
## [1] "9回目のサイコロ投げの結果: 4 （これまでの総和: 26）"
## [1] "10回目のサイコロ投げの結果: 3 （これまでの総和: 29）"
## [1] "11回目のサイコロ投げの結果: 6 （これまでの総和: 35）"
```
