...
## [1] "2回目のサイコロ投げの結果: 4（これまでの総和: 8）"
## [1] "3回目のサイコロ投げの結果: 5（これまでの総和: 13）"
## [1] "4回目のサイコロ投げの結果: 4（これまでの総和: 17）"
## [1] "5回目のサイコロ投げの結果: 1（これまでの総和: 18）"
## [1] "6回目のサイコロ投げの結果: 4（これまでの総和: 22）"
## [1] "7回目のサイコロ投げの結果: 3（これまでの総和: 25）"
## [1] "8回目のサイコロ投げの結果: 6（これまでの総和: 31）"
```
...
```
## [1] "1回目のサイコロ投げの結果: 4 （これまでの総和: 4）"
## [1] "2回目のサイコロ投げの結果: 3 （これまでの総和: 7）"
## [1] "3回目のサイコロ投げの結果: 5 （これまでの総和: 12）"
## [1] "4回目のサイコロ投げの結果: 5 （これまでの総和: 17）"
## [1] "5回目のサイコロ投げの結果: 2 （これまでの総和: 19）"
## [1] "6回目のサイコロ投げの結果: 2 （これまでの総和: 21）"
## [1] "7回目のサイコロ投げの結果: 5 （これまでの総和: 26）"
## [1] "8回目のサイコロ投げの結果: 3 （これまでの総和: 29）"
## [1] "9回目のサイコロ投げの結果: 2 （これまでの総和: 31）"
```
