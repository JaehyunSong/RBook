...
\caption{`mean()`関数のヘルプ画面}(\#fig:programming-intro-4)
\end{figure}
...
\caption{パンチカードの例}(\#fig:programming-style-26)
\end{figure}
...
## [1] "2回目のサイコロ投げの結果: 1（これまでの総和: 6）"
## [1] "3回目のサイコロ投げの結果: 2（これまでの総和: 8）"
## [1] "4回目のサイコロ投げの結果: 6（これまでの総和: 14）"
## [1] "5回目のサイコロ投げの結果: 1（これまでの総和: 15）"
## [1] "6回目のサイコロ投げの結果: 6（これまでの総和: 21）"
## [1] "7回目のサイコロ投げの結果: 2（これまでの総和: 23）"
## [1] "8回目のサイコロ投げの結果: 5（これまでの総和: 28）"
## [1] "9回目のサイコロ投げの結果: 4（これまでの総和: 32）"
```
...
## [1] "3回目のサイコロ投げの結果: 2 （これまでの総和: 13）"
## [1] "4回目のサイコロ投げの結果: 3 （これまでの総和: 16）"
## [1] "5回目のサイコロ投げの結果: 3 （これまでの総和: 19）"
## [1] "6回目のサイコロ投げの結果: 1 （これまでの総和: 20）"
## [1] "7回目のサイコロ投げの結果: 4 （これまでの総和: 24）"
## [1] "8回目のサイコロ投げの結果: 2 （これまでの総和: 26）"
## [1] "9回目のサイコロ投げの結果: 3 （これまでの総和: 29）"
## [1] "10回目のサイコロ投げの結果: 6 （これまでの総和: 35）"
```
