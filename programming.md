...
## [1] "2回目のサイコロ投げの結果: 2（これまでの総和: 3）"
## [1] "3回目のサイコロ投げの結果: 3（これまでの総和: 6）"
## [1] "4回目のサイコロ投げの結果: 2（これまでの総和: 8）"
## [1] "5回目のサイコロ投げの結果: 4（これまでの総和: 12）"
## [1] "6回目のサイコロ投げの結果: 2（これまでの総和: 14）"
## [1] "7回目のサイコロ投げの結果: 5（これまでの総和: 19）"
## [1] "8回目のサイコロ投げの結果: 5（これまでの総和: 24）"
## [1] "9回目のサイコロ投げの結果: 1（これまでの総和: 25）"
## [1] "10回目のサイコロ投げの結果: 6（これまでの総和: 31）"
```
...
## [1] "6回目のサイコロ投げの結果: 2 （これまでの総和: 16）"
## [1] "7回目のサイコロ投げの結果: 2 （これまでの総和: 18）"
## [1] "8回目のサイコロ投げの結果: 6 （これまでの総和: 24）"
