...
## [1] "3回目のサイコロ投げの結果: 1（これまでの総和: 9）"
## [1] "4回目のサイコロ投げの結果: 2（これまでの総和: 11）"
## [1] "5回目のサイコロ投げの結果: 6（これまでの総和: 17）"
## [1] "6回目のサイコロ投げの結果: 5（これまでの総和: 22）"
## [1] "7回目のサイコロ投げの結果: 4（これまでの総和: 26）"
## [1] "8回目のサイコロ投げの結果: 6（これまでの総和: 32）"
```
...
## [1] "4回目のサイコロ投げの結果: 1 （これまでの総和: 10）"
## [1] "5回目のサイコロ投げの結果: 2 （これまでの総和: 12）"
## [1] "6回目のサイコロ投げの結果: 6 （これまでの総和: 18）"
## [1] "7回目のサイコロ投げの結果: 4 （これまでの総和: 22）"
## [1] "8回目のサイコロ投げの結果: 4 （これまでの総和: 26）"
## [1] "9回目のサイコロ投げの結果: 2 （これまでの総和: 28）"
## [1] "10回目のサイコロ投げの結果: 5 （これまでの総和: 33）"
```
