...
## [1] "2回目のサイコロ投げの結果: 6（これまでの総和: 12）"
## [1] "3回目のサイコロ投げの結果: 6（これまでの総和: 18）"
## [1] "4回目のサイコロ投げの結果: 2（これまでの総和: 20）"
...
## [1] "2回目のサイコロ投げの結果: 3 （これまでの総和: 4）"
## [1] "3回目のサイコロ投げの結果: 6 （これまでの総和: 10）"
## [1] "4回目のサイコロ投げの結果: 3 （これまでの総和: 13）"
## [1] "5回目のサイコロ投げの結果: 1 （これまでの総和: 14）"
## [1] "6回目のサイコロ投げの結果: 1 （これまでの総和: 15）"
## [1] "7回目のサイコロ投げの結果: 6 （これまでの総和: 21）"
## [1] "8回目のサイコロ投げの結果: 3 （これまでの総和: 24）"
## [1] "9回目のサイコロ投げの結果: 4 （これまでの総和: 28）"
## [1] "10回目のサイコロ投げの結果: 4 （これまでの総和: 32）"
```
