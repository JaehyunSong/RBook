...
　その他の図ついては第[-@sec-visualization4]章、図の細かい修正については第[-@sec-visualization3]で解説します。また、使用するPCの環境によっては図の文字化けが生じる可能性があります。この場合は第[-@sec-visual2-japanese]章を参照してください（{ragg}パッケージを使えば一発で解決できます）。
